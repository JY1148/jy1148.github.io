...
const Banner: React.FC<BannerProps> = ({ data }) => {
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center bg-white" id="banner-section">
      <div className="flex-1 p-12 md:p-32 flex flex-col justify-center items-start order-2 md:order-1 max-w-3xl">
        <h1 id="banner-name" className="text-5xl md:text-6xl font-light mb-6 tracking-tight text-gray-900">{data.name}</h1>
        <p className="text-xl md:text-2xl mb-8 leading-relaxed font-light text-gray-700" id="banner-bio">
        ...
        <ul className="flex gap-6 mb-10 text-2xl text-gray-400" id="banner-social">
